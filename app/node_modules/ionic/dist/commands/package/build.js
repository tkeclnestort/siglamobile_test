        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!options['profile'] && (inputs[0] === 'ios' || (inputs[0] === 'android' && options['release']))) {
                ...
                if (profiles.length === 0) {
                    throw new errors_1.FatalException(`Sorry--a valid ${chalk.bold(desiredProfileType)} security profile is required for ${pkg.formatPlatform(inputs[0])} ${options['release'] ? 'release' : 'debug'} builds.`);
                }
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof profile === 'string') {
                ...
                if (!p.credentials[platform]) {
                    throw new errors_1.FatalException(`Profile ${chalk.bold(p.tag)} (${chalk.bold(p.name)}) was found, but didn't have credentials for ${pkg.formatPlatform(platform)}.`); // TODO: link to docs
                }
                if (release && p.type !== 'production') {
                    throw new errors_1.FatalException(`Profile ${chalk.bold(p.tag)} (${chalk.bold(p.name)}) is a ${chalk.bold(p.type)} profile, which won't work for release builds.\n` +
